...
int main() {
   ...
   cout << "Inserting after node 2 now" << endl;
   IntNode* nodeObj4 = new IntNode(12345);
   nodeObj2->InsertAfter(nodeObj4);
  ...
  //now do this again, but insert after the node that printed 555...

  //we'll just print again here for the output to see the difference
